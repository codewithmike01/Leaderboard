...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/scoreEntry.js */ \"./src/module/scoreEntry.js\");\n/* harmony import */ var _module_apiRequest_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/apiRequest.js */ \"./src/module/apiRequest.js\");\n\n\n\n\nasync function display() {\n  const getUser = await (0,_module_apiRequest_js__WEBPACK_IMPORTED_MODULE_2__.getUserScore)();\n  getUser.result.sort((a, b) => b.score - a.score);\n  (0,_module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.render)(getUser.result);\n}\n\nfunction starter() {\n  display();\n}\n\n_module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.formOne.addEventListener('submit', async (e) => {\n  e.preventDefault();\n  (0,_module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.validateInput)();\n  await (0,_module_apiRequest_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  _module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.inputName.value = ' ';\n  _module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.inputScore.value = ' ';\n  starter();\n});\n\n_module_scoreEntry_js__WEBPACK_IMPORTED_MODULE_1__.refresh.addEventListener('click', () => {\n  display();\n});\n\nstarter();\n\n\n//# sourceURL=webpack://todolist-with-webpack/./src/index.js?");

/***/ }),

/***/ "./src/module/apiRequest.js":
/*!**********************************!*\
  !*** ./src/module/apiRequest.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ addUserScore),\n/* harmony export */   \"getUserScore\": () => (/* binding */ getUserScore)\n/* harmony export */ });\n/* harmony import */ var _scoreEntry_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scoreEntry.js */ \"./src/module/scoreEntry.js\");\n\n\nasync function addUserScore() {\n  const userData = { user: _scoreEntry_js__WEBPACK_IMPORTED_MODULE_0__.inputName.value, score: _scoreEntry_js__WEBPACK_IMPORTED_MODULE_0__.inputScore.value };\n  const response = await fetch(\n    'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/5TiAAPGCZSdzS3sSfE2C/scores/',\n    {\n      method: 'POST',\n      headers: {\n        'Content-Type': 'application/json',\n      },\n      body: JSON.stringify(userData),\n      // eslint-disable-next-line comma-dangle\n    }\n  );\n  const data = await response.json();\n  return data;\n}\n\nasync function getUserScore() {\n  const response = await fetch(\n    // eslint-disable-next-line comma-dangle\n    'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/5TiAAPGCZSdzS3sSfE2C/scores/'\n  );\n  const data = await response.json();\n  return data;\n}\n\n\n//# sourceURL=webpack://todolist-with-webpack/./src/module/apiRequest.js?");
